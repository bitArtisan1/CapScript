    ...
    new_theme_qss = f"""
        ...
        * {{
        ...
        #customTitleBar QPushButton {{
             background-color: transparent;
            color: {COLOR_DARK_GRAY}; /* Keep consistent for controls */
             border: none;
             border-radius: 3px;
             font-weight: bold;
             font-size: 11pt;
        ...
        #navButton {{
            ...
            border-radius: 4px;
            /* spacing: 10px; /* This is not a standard QSS property */
            font-weight: 500;
        }}
        #navButton:hover {{
            background-color: rgba(125, 10, 10, 0.1);
        ...
        /* --- Content Area (StackedWidget & Pages) --- */
        #stackedWidget {{
            background-color: {bg_color};
        }}

        /* --- General Widgets (within pages) --- */
        QLabel {{
            color: {text_color};
            background-color: transparent;
            padding: 2px;
        ...
        QGroupBox {{
            font-weight: bold;
            color: {border_color_main}; /* Match border color */
        ...
        QTextBrowser#viewerDisplay a:hover {{
            color: {button_hover_bg}; /* Use button hover color for link hover */
        ...
        QLabel#versionLabel {{
            ...
            font-size: 8pt;
            padding: 0px 5px 5px 5px; /* Adjust padding */
            background-color: transparent;
            border: none;
            /* text-align: center; /* Alignment is handled by layout */
        }}

        /* --- Specific Button Styles (Donate, GitHub) --- */
